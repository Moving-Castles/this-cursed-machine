...
export const entitiesInBox = derived([entities, playerCore], ([$entities, $playerCore]) => {
  return Object.fromEntries(Object.entries($entities).filter(([, entity]) => entity.carriedBy === $playerCore.carriedBy)) as Entities;
});
