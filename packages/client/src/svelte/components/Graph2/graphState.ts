...
import { machinesInPlayerPod, playerPod } from "../../modules/state";
...
export const graphState = derived([playerPod, machinesInPlayerPod], ([$playerPod, $machinesInPlayerPod]) => {
    return layout($playerPod.fixedEntities, $machinesInPlayerPod);
});