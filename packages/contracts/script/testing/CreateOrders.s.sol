...
contract CreateOrder is Script {
  function run(address worldAddress) external {
    ...
    LibOrder.create(admin, "", PublicMaterials.EVIAN, 13000, false, 0, 210, 0, 0);

    // 50 LOW_GRADE_AMPHETAMINE => 500 points
    LibOrder.create(admin, "", PublicMaterials.LOW_GRADE_AMPHETAMINE, 5000, false, 0, 500, 0, 0);

    // 90 CONGEALED_FAT => 140 points
    LibOrder.create(admin, "", PublicMaterials.CONGEALED_FAT, 9000, false, 0, 140, 0, 0);
    ...
    LibOrder.create(admin, "", PublicMaterials.HEMATURIC_FLUID, 5000, false, 0, 200, 0, 0);
    ...
    LibOrder.create(admin, "", PublicMaterials.INDUSTRIAL_LUBRICANT, 9000, false, 0, 240, 0, 0);
