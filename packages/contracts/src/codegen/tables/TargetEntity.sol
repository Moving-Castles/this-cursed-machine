...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mc"), bytes16("TargetEntity")));
bytes32 constant TargetEntityTableId = _tableId;

library TargetEntity {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TargetEntity", _fieldNames);
  }
