...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "LastResolved", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004c6173745265736f6c76656400000000);
ResourceId constant LastResolvedTableId = _tableId;
