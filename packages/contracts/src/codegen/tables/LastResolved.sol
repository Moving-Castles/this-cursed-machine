...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mc"), bytes16("LastResolved")));
bytes32 constant LastResolvedTableId = _tableId;

library LastResolved {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LastResolved", _fieldNames);
  }
