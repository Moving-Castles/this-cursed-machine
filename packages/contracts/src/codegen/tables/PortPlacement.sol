...
// Import user types
import { PORT_PLACEMENT } from "./../Types.sol";

bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mc"), bytes16("PortPlacement")));
bytes32 constant PortPlacementTableId = _tableId;
...
library PortPlacement {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PortPlacement", _fieldNames);
  }
  ...
  function get(bytes32 key) internal view returns (PORT_PLACEMENT value) {
    ...
    return PORT_PLACEMENT(uint8(Bytes.slice1(_blob, 0)));
  }
  ...
  function encode(PORT_PLACEMENT value) internal pure returns (bytes memory) {
