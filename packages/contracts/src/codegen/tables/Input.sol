...
library Input {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Input", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000496e7075740000000000000000000000);
