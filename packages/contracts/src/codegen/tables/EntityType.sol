...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14("mc"), bytes16("EntityType")))
);
ResourceId constant EntityTypeTableId = _tableId;
...
library EntityType {
  ...
  /** Get value */
  function _getValue(bytes32 key) internal view returns (ENTITY_TYPE value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Get value */
  function get(bytes32 key) internal view returns (ENTITY_TYPE value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Get value */
  function _get(bytes32 key) internal view returns (ENTITY_TYPE value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Set value */
  function _setValue(bytes32 key, ENTITY_TYPE value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Set value */
  function set(bytes32 key, ENTITY_TYPE value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Set value */
  function _set(bytes32 key, ENTITY_TYPE value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function encode(ENTITY_TYPE value) internal pure returns (bytes memory, PackedCounter, bytes memory) {
