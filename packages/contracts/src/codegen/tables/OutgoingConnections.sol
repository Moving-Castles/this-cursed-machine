...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "OutgoingConnecti", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004f7574676f696e67436f6e6e65637469);
ResourceId constant OutgoingConnectionsTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0000000100000000000000000000000000000000000000000000000000000000
);

library OutgoingConnections {
  /**
