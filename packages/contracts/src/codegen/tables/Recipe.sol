...
// Import user types
import { MACHINE_TYPE, MATERIAL_TYPE } from "./../common.sol";

ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("Recipe")))
);
ResourceId constant RecipeTableId = _tableId;
