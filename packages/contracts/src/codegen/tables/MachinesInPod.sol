...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MachinesInPod", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d616368696e6573496e506f64000000);
ResourceId constant MachinesInPodTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0000000100000000000000000000000000000000000000000000000000000000
);

library MachinesInPod {
  /**
