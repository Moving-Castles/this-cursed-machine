...
library LibMaterial {
  /**
   * @notice Creates a new material entity and associates it with a pod and player entity
   * @dev Generates a unique identifier for the material, setting its properties and linking it to pod and player entities
   * @param _materialType The type of material to create
   * @param _scaledAmount The scaled amount of the material
   * @param _podEntity The identifier of the pod entity that will carry the material
   * @param _playerEntity The identifier of the player entity responsible for creating the material
  ...
  function create(
    ...
    CreatedBy.set(materialEntity, _playerEntity);
  ...
  /**
   * @dev Removes material from the pod without really destroying it
   * @param _materialEntity The unique identifier of the material entity to be destroyed
   */
