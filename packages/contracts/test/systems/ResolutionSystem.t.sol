...
contract ResolutionSystemTest is MudV2Test {
  ...
  function testResolve2() public {
    ...
    vm.startPrank(alice);
    world.mc_ConnectionSystem_connect(CONNECTION_TYPE.RESOURCE, coreOutputPorts[0][0], outletInputPorts[0][0]);
    vm.stopPrank();
  ...
  function testResolve3() public {
    ...
    vm.startPrank(alice);
    world.mc_ConnectionSystem_connect(CONNECTION_TYPE.RESOURCE, coreOutputPorts[1][0], outletInputPorts[1][0]);
    vm.stopPrank();
