...
contract DestroySystemTest is BaseTest {
  function testDestroy() public {
    ...
    startGasReport("Destroy machine");
    world.removeMachine(machineEntity);
    endGasReport();
  ...
  function testDestroyConnections() public {
    ...
    // Build a boiler
    bytes32 boilerEntity = world.buildMachine(MACHINE_TYPE.BOILER);
    ...
    // Destroy splitter
    world.removeMachine(splitterEntity);
